...
export const VietnamMap = ({ data = {}, onProvinceClick, }) => {
    ...
    useEffect(() => {
        ...
        const renderMap = () => {
            ...
            if (hasData) {
                ...
                const domainMax = isFinite(max) && max !== min ? max : domainMin + 1;
                color = d3
    ...
    return (_jsx("svg", { ref: svgRef, className: "block h-full w-full", style: { background: "transparent" } }));
};
