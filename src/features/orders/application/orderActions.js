...
export const OrderActions = {
    async approveOrder(order, userId) {
    ...
    async rejectOrder(order, reason, userId) {
        await updateOrder(order.id, userId, {
    ...
    async flagVerification(order, reason, userId) {
        await updateOrder(order.id, userId, {
    ...
    async simulateConfirmed(order, userId) {
    ...
    async simulateCancelled(order, userId) {
        await updateOrder(order.id, userId, {
    ...
    async simulatePaid(order, userId) {
    ...
    async markShipped(order, userId) {
        await updateOrder(order.id, userId, {
    ...
    async markCompleted(order, userId) {
        await updateOrder(order.id, userId, {
    ...
    async updateProduct(order, productId, productName, userId) {
    ...
    async deleteOrdersAction(orderIds, ordersToDelete, userId) {
